...
\begin{itemize}
    ...
    \item Improved the description for the variable \verb|MEDIAN HOUSING PRICE|
    \item Improved EDA plot descriptions
    \item Furthered model diagonistic discussion in the statistic analysis section.
    \item Re-organized some discussion so model is stated earlier.
\end{itemize}
...
\section*{Discussion}
Using multiple linear regression, we derived a model (table 6) that uses housing type, income, and interest rate, to describe the relationship between macroeconomic factors and housing prices in Metro Vancouver. \\
