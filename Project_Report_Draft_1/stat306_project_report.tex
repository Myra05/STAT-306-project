...
\textbf{Variable Name(s)} & \textbf{Type} & \textbf{Description} \\ \hline
\endhead
CMA ID & Integer & \multirow{2}{=}{Census metropolitan area ID/Name assigned by Statistics Canada, which corresponds to population centres. See the definition on their \href{https://www12.statcan.gc.ca/census-recensement/2021/ref/dict/az/definition-eng.cfm?ID=geo009}{website}.} \\[4ex] \cline{1-2}
...
MEDIAN HOUSING PRICE & Integer & Sale price for a particular year/quarter/house-type. (CAD) \\ \hline
...
Diagnostic plots (Figure 4) for the final linear regression model, including the residuals-versus-fitted and scale-location plots, suggest roughly constant variance overall, although there is small non-constant spread at the extremes. The Q-Q plot shows a consistent trend, with little deviation even at the extremes, meaning the assumption of normality is unlikely violated.
...
\href{https://catalogue.data.gov.bc.ca/dataset/b-c-housing-affordability/resource/f8153a37-f18d-4d4e-bbe6-77f648bc1f31=}{link}
\end{document}
